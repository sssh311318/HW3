...
define_hls_config       GaussianFilter PIPELINE -DII=3
define_hls_config	GaussianFilter UNROLL_FILL
define_hls_config	GaussianFilter UNROLL_ALL
define_hls_config	GaussianFilter FLAT_UNROLL_ALL --flatten_arrays=all -DUNROLL_ALL
set IMAGE_DIR           ".."
...
define_sim_config V_UNROLL_FILL "GaussianFilter RTL_V UNROLL_FILL" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
